...
# set -e
# url="http://$SE_HOST:4444/wd/hub/status"
...
selenium-side-runner --server http://$SE_HOST:4444/wd/hub -c "goog:chromeOptions.args=[--headless,--nogpu] browserName=chrome" --output-directory /root/out /sides/*.side $@
